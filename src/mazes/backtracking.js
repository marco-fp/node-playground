/* 
    From: http://rosettacode.org/wiki/Maze_generation#JavaScript
    ...
    Variable meanings in function display:
        ...
        Note that this implementation relies on javascript arrays being treatable as infinite in size with false (null) values springing into existence as needed, 
        to support referenced array locations. (This significantly reduces the bulk of the necessary initialization code.)
*/
...
function display(m) {
    console.log(JSON.stringify(m.verti));
    var text = [];
